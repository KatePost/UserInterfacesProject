...
document.writeln('<img id="bigLogo" src="images/tasteofbakingbig.png" alt="Home | Taste of Baking Logo" title="Home" />');
document.writeln('<img id="smallLogo" src="images/tasteofbakingsmall.png" alt="Home | Taste of Baking Logo" title="Home"/>');
